...
class BoardAdapter(private val startClick: () -> Unit) :
    RecyclerView.Adapter<BoardAdapter.ViewHolder>() {
    private val titles =
        arrayListOf("Welcome to MathSupreme!", "", "Your personal Supreme Calculator!")
    private val description = arrayListOf(
        "This application will help you in calculating complex arithmetic, trigonometric problems",
    ...
    inner class ViewHolder(private var binding: PagerBoardBinding) :
        ...
        fun bind(position: Int) {
            ...
            with(binding) {
                ...
                if (position == titles.size - 1) btnStart.visibility = View.VISIBLE
